...
export function createTools(config = {}) {
    return [
        {
            name: TOOL_ASK,
            description: 'Send a text or coding task to the local Grok Build CLI (logged-in `grok`, headless). Use for writing, review, planning, or code edits. Do not use this for generating images or videos — call grok_imagine_image or grok_imagine_video instead.',
            parameters: {
                prompt: {
                    type: 'string',
                    required: true,
        ...
        {
            name: TOOL_IMAGE,
            description: 'Generate or edit a still image with the local Grok Imagine tools (`image_gen` / `image_edit`) via the logged-in `grok` CLI. Use when the user wants a picture, poster, cover, illustration, or image edit. Do not use for video clips or for ordinary text/code work.',
            parameters: {
                prompt: {
                    type: 'string',
                    required: true,
        ...
        {
            name: TOOL_VIDEO,
            description: 'Generate a short video with the local Grok Imagine tools. Grok has no text-to-video: this stages a still (`image_gen` / `image_edit`) then animates it (`image_to_video`). Use when the user wants a clip, animation, or image-to-video. Do not use for stills only or for text/code work.',
            parameters: {
                prompt: {
                    type: 'string',
                    required: true,
